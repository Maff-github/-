...
for fi1 in range(0,135,45):
    ...
    for th3 in range(-90,91,10):
        if fi1==0:
            ...
            list_th3_45.append(th3)
                           
        else:
            list_th3_90.append(th3)                
    #Для каждого из сечений задается угол Тета от -90 до 90 градусов с шагом в 1 градус
        for th1 in range(-90,91,1):
            ...
            try:
                ...
                th2=(acos(sin((th3-d_small)*pi/180)*sin(th1*pi/180)
                          *cos((fi1-fi2)*pi/180)+cos((th3-d_small)*pi/180)
                          *cos(th1*pi/180))+acos(sin((th3+d_small)*pi/180)
                            *sin(th1*pi/180)*cos((fi1-fi2)*pi/180)+cos((th3+d_small)
                            *pi/180)*cos(th1*pi/180)))/2
...
#print('Тетаmn_0=',list_th3_0)
#print('Тетаmn_45=',list_th3_45)
#print('Тетаmn_90=',list_th3_90)
plt.show()
